    ...
    function get_cdn() {
        ...
        if (!isset($cdn[0])) {
            ...
            switch ($engine) {
                ...
                case 'transparentcdn':
                    $engine_config = array(
                        'apikey' => $this->_config->get_string('cdn.transparentcdn.apikey'),
                        'apisecret' => $this->_config->get_string('cdn.transparentcdn.apisecret'),
                        'companyid' => $this->_config->get_string('cdn.transparentcdn.companyid'),
                        'domain' => $this->_config->get_array('cdn.transparentcdn.domain'),
                        'compression' => false
                    );
                    break;
