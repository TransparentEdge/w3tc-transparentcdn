...
define('W3TC_CDN_TRANSPARENTCDN', 'transparentcdn');
        ...
        if (!isset($instances[$instance_key])) {
            switch (true) {
                ...
                case ($engine == W3TC_CDN_AKAMAI):
                    ...
                    break;
                case ($engine == W3TC_CDN_TRANSPARENTCDN):
                    w3_require_once(W3TC_LIB_W3_DIR . '/Cdn/Mirror/TransparentCDN.php');
                    $instances[$instance_key] = new W3_Cdn_Mirror_TransparentCDN($config);
                    break;
                default :
