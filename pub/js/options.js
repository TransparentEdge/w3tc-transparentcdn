        ...
        switch (metadata.type) {
            ...
            case 'transparentcdn':
                jQuery.extend(params, {
                    ...
                    'config[apikey]': jQuery('#cdn_transparentcdn_apikey').val(),
                    'config[apisecret]': jQuery('#cdn_transparentcdn_apisecret').val(),
                    'config[companyid]': jQuery('#cdn_transparentcdn_companyid').val()
                });
